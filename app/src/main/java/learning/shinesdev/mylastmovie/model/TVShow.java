...
import learning.shinesdev.mylastmovie.repository.TVShowRepository;
...
public class TVShow extends ViewModel  implements Parcelable {
    ...
    public void search(String keySrc, String lang){
        tvShowRepository = TVShowRepository.getInstance();
        mutableLiveData = tvShowRepository.getSearch(keySrc, lang,ApiUtils.API_KEY);
    }
