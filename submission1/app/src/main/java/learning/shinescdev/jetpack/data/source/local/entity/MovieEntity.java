...
public class MovieEntity {
    ...
    public MovieEntity(int id, @NonNull String title, @NonNull String date, @NonNull String overview, @NonNull String img, @NonNull Double rating, @NonNull int vote, Double renvenue, int favorite) {
        this.id = id;
        this.title = title;
        this.date = date;
    ...
    public void setRenvenue(Double renvenue) {
        this.renvenue = renvenue;
    }
}
